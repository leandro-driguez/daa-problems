...
\section{Enunciado del Problema}
	...
	\begin{prob}
		...
		El administrador lo contrata a usted para que lo ayude, como científico que se considera, a determinar que  valor de $k$ debe elegir el administrador para que el due\~no del bar no lo despida.
	\end{prob}
	...
	de donde arribamos a una contradicci\'on, ya que existe un subarray de tama\~no $k$ de suma no positiva.
